...
export default function PropertiesPanel() {
  const { selectedIds, elements, updateElement, deleteElement } = useBuilderStore()
      ...
      <div className="flex items-center gap-4 px-4 py-3 max-w-full overflow-x-auto">
        ...
        <div className="ml-auto shrink-0">
          <button
            ...
            className="flex items-center gap-1 text-xs text-red-500 hover:text-red-700 border border-red-200 dark:border-red-800 hover:border-red-300 dark:hover:border-red-700 rounded-lg px-2.5 py-1.5 transition-colors"
          >
