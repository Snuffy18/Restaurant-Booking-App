...
export default function CuisineScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <OnboardingProgress total={5} activeIndex={2} />
      <View style={styles.header}>
        <Text style={styles.title}>What cuisines do you love?</Text>
        <Text style={styles.sub}>Helps the assistant tailor suggestions — optional.</Text>
      </View>
      ...
      <View style={styles.footer}>
        <Pressable style={({ pressed }) => [styles.primaryBtn, pressed && { opacity: 0.9 }]} onPress={() => router.push('/onboarding/vibe')}>
          <Text style={styles.primaryLabel}>Continue</Text>
        </Pressable>
        <Pressable onPress={() => router.push('/onboarding/vibe')} style={styles.skip}>
