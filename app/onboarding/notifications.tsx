  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.options}>
        <RadioRow label="All notifications" description="Reminders, confirmations, and tips" selected={choice === 'all'} onPress={() => setChoice('all')} />
        <RadioRow label="Reminders only" description="Booking reminders — nothing promotional" selected={choice === 'reminders'} onPress={() => setChoice('reminders')} />
        <RadioRow label="Not now" description="You can change this anytime in settings" selected={choice === 'not_now'} onPress={() => setChoice('not_now')} />
      </View>
...
const styles = StyleSheet.create({
  ...
  rowOn: { borderColor: Theme.primary, backgroundColor: Theme.primaryMuted },
  radioOuter: {
    width: 22,
    height: 22,
    borderRadius: 11,
  ...
  rowTitle: { fontWeight: '700', color: Theme.text, fontSize: 16 },
  rowSub: { color: Theme.textSecondary, marginTop: 4, lineHeight: 20 },
