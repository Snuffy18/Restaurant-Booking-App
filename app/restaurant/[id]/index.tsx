...
function createStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    tab: { paddingHorizontal: Spacing.md, paddingVertical: 10, borderRadius: Radius.full, backgroundColor: c.card, borderWidth: 1, borderColor: c.border },
    tabOn: { borderColor: c.primary, backgroundColor: c.primaryMuted },
    tabLabel: { fontWeight: '700', color: c.textSecondary },
    tabLabelOn: { color: c.primary },
    section: { paddingBottom: Spacing.md },
    sectionHeading: { fontWeight: '900', color: c.text, marginBottom: Spacing.sm, marginTop: Spacing.md },
    about: { color: c.textSecondary, lineHeight: 22, fontSize: 15 },
    ...
    vibeCardText: { fontWeight: '800', color: c.text },
    reviewCard: {
      backgroundColor: c.card,
      borderRadius: Radius.md,
      padding: Spacing.md,
    ...
    reviewAuthor: { fontWeight: '800', color: c.text, marginBottom: 6 },
    reviewBody: { color: c.textSecondary, lineHeight: 20 },
    ...
    bullet: { color: c.textSecondary, marginBottom: 6 },
    sticky: {
      position: 'absolute',
      left: 0,
      right: 0,
          ...
          {tab === 'overview' ? (
            <View style={styles.section}>
              ...
              <View style={styles.vibeGrid}>
                {Array.from(new Set([...restaurant.vibes, 'Cosy', 'Quiet'])).slice(0, 4).map((v) => (
